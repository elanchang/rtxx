#ifndef __RTMP_ERROR_H__
#define __RTMP_ERROR_H__
...
#define ERROR_SYSTEM_URL_RESOLVE            1067
...
static bool srs_is_system_control_error(int error_code){
    return error_code == ERROR_CONTROL_RTMP_CLOSE
        || error_code == ERROR_CONTROL_REPUBLISH
        || error_code == ERROR_CONTROL_REDIRECT;
}

static bool srs_is_client_gracefully_close(int error_code){
